...
public class PermManager {
	...
	public static void setPerm(EntityPlayerMP player, String perm, boolean value, int chunkX, int chunkZ) throws SQLException {
		
		PermCheck.ensureData(chunkX, chunkZ);	
		
		if (perm.equalsIgnoreCase("chests")) {
			String newPerm = perm.toLowerCase();
			PermModify.permUpdate(newPerm, value, chunkX, chunkZ);
